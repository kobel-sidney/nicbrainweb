...
@FacesConverter(value = "mensagemPickListConverter")
public class MensagensPickListConverter implements Converter {
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) { 
		String str = ""; 
		if (arg2 instanceof Mensagem) 
			str = ((Mensagem) arg2).getId().toString(); 
		return str; 
	} 
