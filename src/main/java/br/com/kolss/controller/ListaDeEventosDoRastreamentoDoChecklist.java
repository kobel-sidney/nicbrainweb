...
@Controller(value = "listaDeEventosDoRastreamentoDoChecklist")
@Scope("session")
public class ListaDeEventosDoRastreamentoDoChecklist {
	...
	private String proximaPagina = 
			"ListaDeChecklistsDoRastreamentoDeChecklist.nicbrain?faces-redirect=true" + 
			"";	// "/restrict/Local.nicbrain"
	
	private Long filtroIdLocal;
	private String filtroIdPessoaResponsavel;
	...
	public ListaDeEventosDoRastreamentoDoChecklist() {
	}
	...
	public String getFiltroIdPessoaResponsavel() {
		return filtroIdPessoaResponsavel;
	}

	public void setFiltroIdPessoaResponsavel(String filtroIdPessoaResponsavel) {
	...
	public EventoDataModel getDataModel() {
		...
		this.dataModel = new EventoDataModel(
				eventoService.getEventosPorChecklistRastreamento(
						getFiltroIdLocal(),
