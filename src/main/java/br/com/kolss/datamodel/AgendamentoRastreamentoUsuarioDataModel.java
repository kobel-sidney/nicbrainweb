 ...
 */
public class AgendamentoRastreamentoUsuarioDataModel extends ListDataModel<AgendamentoRastreamentoUsuario>
		implements SelectableDataModel<AgendamentoRastreamentoUsuario> {
	
	/** Metodo construtor padrao */
	public AgendamentoRastreamentoUsuarioDataModel() {
	}
	
	
	public AgendamentoRastreamentoUsuarioDataModel(List<AgendamentoRastreamentoUsuario> rastreamentos) {
		super(rastreamentos);
	}
