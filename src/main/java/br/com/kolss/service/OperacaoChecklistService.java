...
public interface OperacaoChecklistService {
	 ...
	 */
	void executarOperacao(Serializable idChecklist, Usuario usuario,
	 ...
	 * @return
	 */
	List<OperacaoChecklist> getOperacoesDoChecklist(Checklist checklist)
			throws ServiceException;
